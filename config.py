...
output_samples = False          # If set to True, will generate a file with the sampling results at the end of the run.
exit_on_success = False         # If set to True, will not try to optimize further once a path has been found.
